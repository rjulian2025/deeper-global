...
export const metadata: Metadata = {
  title: "Brand Packages | QV BRANDS",
  description:
    "Strategic brand systems for founders, CMOs, and leadership teams. Start with a $1,500 Brand Clarity Sprint or choose Foundation, Launch, or Signal packages.",
};
  ...
  const packages = [
    {
      ...
      investment: "$1,500",
      description:
        "A focused, high-impact strategic reset for founders who need clarity before committing to a full brand system.",
      descriptionExpanded:
        "This is a short, fixed-scope strategic sprint designed to diagnose positioning, sharpen direction, and identify the highest-leverage growth opportunities. The fastest, lowest-risk way to experience senior-level strategy.",
      outcomes: [
    ...
    },
    {
      ...
      investment: "$5k–$7.5k",
      description:
        "For early-stage or evolving brands that need strategic clarity before scaling.",
      outcomes: [
        "Clear positioning and differentiation",
    ...
    },
    {
      ...
      investment: "$10k–$15k",
      description:
        "For brands preparing to go to market or reposition with confidence.",
      outcomes: [
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto font-light leading-relaxed">
            QV Brands builds market-ready brand systems—strategy, narrative, and
            identity—so your business is understood, chosen, and remembered.
          </p>
          <Button
            asChild
            size="lg"
      ...
      <section className="py-20 px-6 bg-muted/30">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="font-serif text-3xl md:text-4xl font-normal text-foreground mb-8 leading-[1.1]">
            Branding is <span className="italic font-light">decision-first,</span>{" "}
            not design-first.
          </h2>
          <p className="text-lg text-muted-foreground leading-relaxed font-light">
            Before we touch visuals, we establish the strategic foundation: who
            you are, why you matter, and how you differ. Positioning,
            differentiation, and market signal come before aesthetics. This is
            how brands that endure are built—from the inside out.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground font-light">
              Strategic packages for every stage of growth
            </p>
          </div>
              ...
              <Card
                ...
                className={`border ${
                  pkg.featured
                    ...
                    : "border-border"
                } bg-card hover:shadow-lg transition-all duration-300 flex flex-col`}
              >
                <CardContent className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-foreground uppercase tracking-[0.15em] mb-3">
                      Outcomes
                    </h4>
                  ...
                  <div className="pt-6 border-t border-border mt-auto">
                    ...
                    {pkg.microcopy && (
                      <p className="text-xs text-muted-foreground mt-3 font-light text-center">
                        {pkg.microcopy}
                      </p>
                    )}
                  </div>
          ...
          <p className="text-center text-muted-foreground mt-12 text-sm font-light">
            QV Brands engagements typically range from $1,500 to $25k+,
            depending on scope, complexity, and ambition.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <p className="font-serif text-xl md:text-2xl text-foreground mb-10 leading-relaxed font-normal">
            QV Brands is <span className="italic">not</span> for teams seeking
            surface-level design or consensus-driven branding. This work
            requires clarity, conviction, and leadership alignment.
          </p>
          <Button
            asChild
            size="lg"
