...
const Contact = () => {
  const contactPageSchema = {
    ...
    "description": "Start the conversation with QV BRANDS. Book a strategic consultation to discuss your brand vision.",
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-brand-text-light max-w-2xl mx-auto font-light leading-relaxed">
              Ready to build clarity into your brand? Let's discuss your vision and create something that endures.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-16">
            <div>
              <h2 className="text-2xl font-light text-brand-hero mb-6">Get in Touch</h2>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                {/* Honeypot field - hidden from users, bots auto-fill */}
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-xl font-light text-brand-hero mb-4">What to Expect</h3>
                <div className="space-y-4 text-brand-text-light">
                  <p>We'll respond within 24 hours to schedule a strategic conversation.</p>
                  <p>Our initial consultation is complimentary and focused on understanding your unique challenges.</p>
                  <p>If we're a good fit, we'll propose a bespoke approach tailored to your vision and timeline.</p>
                </div>
              </div>

              <div>
                <h3 className="text-xl font-light text-brand-hero mb-4">Our Approach</h3>
                <div className="space-y-3 text-brand-text-light">
                  <div className="border-l-2 border-brand-accent pl-4">
                    <p className="font-medium text-brand-hero">Clarity over Cleverness</p>
                    <p className="text-sm">Strategic thinking that cuts through the noise.</p>
                  </div>
                  <div className="border-l-2 border-brand-accent pl-4">
                    <p className="font-medium text-brand-hero">Built to Endure</p>
                    <p className="text-sm">Brand systems designed for long-term cultural resonance.</p>
                  </div>
                  <div className="border-l-2 border-brand-accent pl-4">
                    <p className="font-medium text-brand-hero">Human + AI Intelligence</p>
                    <p className="text-sm">Next-gen tools guided by timeless strategy.</p>
                  </div>
                </div>
              </div>
            </div>
