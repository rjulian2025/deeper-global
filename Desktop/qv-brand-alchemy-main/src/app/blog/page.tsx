...
export const metadata: Metadata = {
  title: "Blog - Strategic Clarity for Modern Brands",
  description: "Insights on brand strategy, clarity systems, and building identity that endures in the AI era. Articles by Rick Julian, founder of QV BRANDS.",
  keywords: "brand strategy blog, clarity systems, AI-era branding, strategic identity, QV BRANDS insights",
};
